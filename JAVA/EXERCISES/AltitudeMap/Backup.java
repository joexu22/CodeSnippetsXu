...
public class LowPointFinder {
    ...
    public static void test(ArrayList<Node<int[]>> path) {
        int[] int_output = {0,0,0};
        Node<int[]> node_output = new Node<int[]>(int_output);
        path.set(0, node_output);
    }
    ...
    public static int[] isLowest(Map map, int iRow, int iColumn) {
        ...
        // uses currAltitude
        result = currAltitude(map, iRow, iColumn, travelled);
    ...
    public static void printLowestPoint(Map map, int iRow, int iColumn) {
        ...
        int[] result = isLowest(map, iRow, iColumn);
    ...
    public static void main(String[] args) {
        ...
        // printLowestPoint(map, 3, 0);
        // printLowestPoint(map, 6, 3);
